    ...
    switch (ticket.status) {
      case "ACTIVE":
        return (
          ...
          >
            <span style={{ color: "#00101F" }}>Status:</span> Otvoren
          </span>
        );
        break;
      case "ASSIGNED":
        return (
          ...
          >
            <span style={{ color: "#00101F" }}>Status:</span> U obradi
          </span>
        );
        break;
      case "VERIFIED":
        return (
          ...
          >
            <span style={{ color: "#00101F" }}>Status:</span> Verifikovan
          </span>
        );
        break;
      case "CLOSED":
        return (
          ...
          >
            <span style={{ color: "#00101F" }}>Status:</span> Zatvoren
          </span>
        );
        break;
    }
